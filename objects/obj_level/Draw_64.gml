...
if(global.game_over){
	...
	draw_text(_wdw_w, _wdw_h/2 + 80, "Score: " + string(global.points));			//Desenhando os pontos feito na quelap artida do jogo
...
draw_text(2, 2, string(global.seconds));			//Desenhando o tempo do jogo

//Alinhando o texto na horizontal e vertical
draw_set_halign(1);
draw_set_valign(1);
if(global.start_game){draw_text(_wdw_w, _wdw_h/2, "Press space key to begin")}		//Se variavel global for false, mostra texto
draw_text(_wdw_w, 30, global.points);												//Desenhando a pontuação atual do jogador 
