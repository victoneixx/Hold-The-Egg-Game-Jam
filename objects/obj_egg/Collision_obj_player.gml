...
global.points++;								//Quando o ovjeto colidr com o player, adicionando mais um na variavel global
...
instance_create_layer(x, y, layer, obj_grenn);	//Quando o ovo colidir com o player, criar o objeto grenn